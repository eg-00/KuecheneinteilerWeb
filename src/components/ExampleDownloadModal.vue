  ...
  >
    ...
    <div class="modal-body">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 12px; margin-bottom: 28px;">
        <!-- People CSV Download -->
        <a href="/people_example.csv" download class="btn-primary" style="display: flex; flex-direction: column; align-items: center; gap: 8px; height: auto; padding: 16px; text-decoration: none; justify-content: center;">
        ...
        <!-- Meals CSV Download -->
        <a href="/meals_example.csv" download class="btn-success" style="display: flex; flex-direction: column; align-items: center; gap: 8px; height: auto; padding: 16px; text-decoration: none; justify-content: center;">
          <span style="font-size: 2rem;">🍳</span>
          <span>meals.csv</span>
